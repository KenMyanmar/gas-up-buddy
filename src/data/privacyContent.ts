...
This Policy forms part of the 8484Gas Mini App Terms and Conditions and should be read together with those terms. By accessing and using the Mini App, you confirm that you have read and understood this Policy and consent to the collection, use, and disclosure of your personal information as described herein. If you do not agree with this Policy, please do not use the Mini App.`,
    ...
    mm: {
      title: "၁။ နိဒါန်း",
      body: `ဤကိုယ်ရေးအချက်အလက်ဆိုင်ရာ မူဝါဒ ("မူဝါဒ") သည် သင်သည် KBZPay application အတွင်းရှိ 8484Gas Mini App ("Mini App") ကို ဝင်ရောက်အသုံးပြုသည့်အခါ 8484 Co., Ltd. ("ကျွန်ုပ်တို့", "ကျွန်ုပ်တို့၏" သို့မဟုတ် "8484Gas") က သင်၏ ကိုယ်ရေးအချက်အလက်များကို မည်သို့ စုဆောင်း၊ အသုံးပြု၊ မျှဝေ နှင့် ကာကွယ်ပုံကို ရှင်းလင်းဖော်ပြထားပါသည်။ ဤမူဝါဒသည် 8484Gas Mini App ၏ Terms and Conditions ၏ တစ်စိတ်တစ်ပိုင်းဖြစ်ပြီး အဆိုပါ စည်းကမ်းသတ်မှတ်ချက်များနှင့်အတူ ဖတ်ရှုသင့်ပါသည်။

သင်သည် Mini App ကို ဝင်ရောက်အသုံးပြုခြင်းအားဖြင့် ဤမူဝါဒကို ဖတ်ရှုနားလည်ပြီး ဖြစ်ကြောင်းနှင့် ဤတွင် ဖော်ပြထားသည့်အတိုင်း သင်၏ ကိုယ်ရေးအချက်အလက်များကို စုဆောင်း၊ အသုံးပြု နှင့် ဖော်ထုတ်မျှဝေရန် သဘောတူကြောင်း အတည်ပြုပါသည်။ ဤမူဝါဒကို သဘောမတူပါက Mini App ကို အသုံးမပြုရပါ။`,
    },
  },
  {
    en: {
...
• Delivery completion timestamps and, in some cases, proof-of-delivery photos taken by the agent`,
    ...
    mm: {
      ...
      body: `**3.1 သင်က တိုက်ရိုက် ပေးအပ်သော အချက်အလက်များ**
...
**3.2 KBZPay မှ လက်ခံရရှိသော အချက်အလက်များ**
...
**3.3 အသုံးပြုနေစဉ် အလိုအလျောက် စုဆောင်းသည့် အချက်အလက်များ**
...
**3.4 ပို့ဆောင်မှုအတွင်း ထွက်ပေါ်လာသော အချက်အလက်များ**
...
**6.1 တာဝန်ချမှတ်ထားသော Delivery Agent များနှင့်**
...
**6.2 KBZPay (Kanbawza Bank Limited) နှင့်**
...
**6.3 ကျွန်ုပ်တို့၏ ဝန်ဆောင်မှုပေးသူများနှင့်**
...
**6.4 ဥပဒေရေးရာနှင့် စည်းမျဉ်းကြီးကြပ်ရေး အာဏာပိုင်များနှင့်**
...
**6.5 ကော်ပိုရိတ် လုပ်ငန်းလွှဲပြောင်းမှုအတွင်း**
...
We have selected providers that offer appropriate technical and organisational safeguards for data transfers, including encryption of data in transit and at rest, certified data-centre security standards, and contractual data-protection commitments.`,
    ...
    mm: {
      ...
      body: `သင်၏ ကိုယ်ရေးအချက်အလက်များကို စင်္ကာပူဒေသတွင် တည်ရှိသော Supabase နှင့် DigitalOcean ၏ server များပေါ်တွင် ဆောင်ရွက်ပြီး သိမ်းဆည်းထားပါသည်။ Mini App ကို အသုံးပြုခြင်းအားဖြင့် သင်၏ အချက်အလက်များကို မြန်မာနိုင်ငံပြင်ပ စင်္ကာပူဒေသသို့ လွှဲပြောင်းရန် သင်သဘောတူပါသည်။ ကျွန်ုပ်တို့သည် data transfer အတွက် သင့်လျော်သော နည်းပညာပိုင်းနှင့် စီမံခန့်ခွဲမှုဆိုင်ရာ ကာကွယ်မှုများ ပေးနိုင်သော provider များကို ရွေးချယ်ထားပြီး ၎င်းတွင် data in transit နှင့် at rest encryption၊ အသိအမှတ်ပြု data centre security standard များနှင့် စာချုပ်အရ data-protection commitment များ ပါဝင်ပါသည်။`,
    },
  },
  {
    en: {
...
အသုံးပြုနေသော customer profile

သင့် account အသုံးပြုနေသရွေ့

အသုံးမပြုတော့သော customer profile

နောက်ဆုံးအော်ဒါတင်ပြီး 24 လအထိ၊ ထို့နောက် ဖျက်ပစ်ခြင်း သို့မဟုတ် anonymise ပြုလုပ်ခြင်း

အော်ဒါနှင့် transaction မှတ်တမ်းများ

7 နှစ် (မြန်မာနိုင်ငံ၏ စာရင်းကိုင်နှင့် အခွန်ဆိုင်ရာ လိုအပ်ချက်များ)

marketing consent မှတ်တမ်းများ

သဘောတူညီချက် ပြန်လည်ရုပ်သိမ်းသည့်အချိန်အထိ

delivery agent location log များ

အော်ဒါပြီးဆုံးပြီး 30 ရက်

နည်းပညာနှင့် လုံခြုံရေး log များ
...
ဤအခွင့်အရေးများကို အသုံးပြုလိုပါက အောက်ပါ အပိုဒ် 14 တွင် ဖော်ပြထားသော ဆက်သွယ်ရန် အချက်အလက်များမှတဆင့် ကျွန်ုပ်တို့ထံ ဆက်သွယ်ပါ။ ကျွန်ုပ်တို့သည် ပြည့်စုံသော တောင်းဆိုချက်ကို လက်ခံရရှိပြီး ရက် 30 အတွင်း တုံ့ပြန်ပါမည်။ သင်၏ တောင်းဆိုချက်ကို ဖြည့်ဆည်းဆောင်ရွက်မီ ကျွန်ုပ်တို့သည် သင်၏ အထောက်အထားကို စစ်ဆေးရန် လိုအပ်နိုင်ပါသည်။`,
    },
  },
  {
    en: {
    ...
    mm: {
      ...
      body: `Mini App သည် အသက် 18 နှစ်နှင့် အထက် အသုံးပြုသူများအတွက် ရည်ရွယ်ထားပါသည်။ အသက် 18 နှစ်မပြည့်သေးသူများသည် အခကြေးငွေများအတွက် တာဝန်ယူမည်ဟု သဘောတူသော မိဘ သို့မဟုတ် ဥပဒေအရ တာဝန်ရှိသူ၏ တိကျရှင်းလင်းသော သဘောတူညီချက်ဖြင့်သာ ဝန်ဆောင်မှုကို အသုံးပြုနိုင်ပါသည်။ ကျွန်ုပ်တို့သည် အသက် 13 နှစ်အောက် ကလေးများထံမှ ကိုယ်ရေးအချက်အလက်များကို သိရှိထားလျက် မစုဆောင်းပါ။ မိဘ၏ အတည်ပြုထားသော သဘောတူညီချက်မရှိဘဲ အသက် 13 နှစ်အောက် ကလေးတစ်ဦး၏ ကိုယ်ရေးအချက်အလက်ကို စုဆောင်းထားကြောင်း သိရှိလာပါက ထိုအချက်အလက်ကို အမြန်ဆုံး ဖျက်ပစ်ရန် လုပ်ဆောင်ပါမည်။`,
    },
  },
  {
    en: {
...
Data Controller: 8484 Co., Ltd. (a company registered in Myanmar)`,
    ...
    mm: {
      ...
      body: `privacy နှင့်သက်ဆိုင်သော မေးခွန်းများ၊ သင်၏ အခွင့်အရေးများကို အသုံးပြုလိုသည့် တောင်းဆိုချက်များ သို့မဟုတ် တိုင်ကြားမှုများအတွက် အောက်ပါအချက်အလက်များဖြင့် ကျွန်ုပ်တို့ထံ ဆက်သွယ်နိုင်ပါသည်။ ကျွန်ုပ်တို့သည် စုံစမ်းမေးမြန်းမှုအားလုံးကို ရက် 30 အတွင်း တုံ့ပြန်ရန် ရည်ရွယ်ပါသည်။
...
8484 (ဖုန်းနံပါတ်: 09 880 441 006)

**စာပို့လိပ်စာ**

8484 Co., Ltd., Yangon, Myanmar [registered address အပြည့်အစုံ ထပ်မံဖြည့်ရန်]

**Data Controller**

8484 Co., Ltd. (မြန်မာနိုင်ငံတွင် မှတ်ပုံတင်ထားသော ကုမ္ပဏီ)`,
    },
  },
  {
    en: {
  ...
  },
  {
    en: {
      title: "17. Language",
      body: `This Policy is issued in both English and Myanmar. Both language versions have the same legal effect.`,
    },
    mm: {
      title: "၁၇။ ဘာသာစကား",
      body: `ဤမူဝါဒကို အင်္ဂလိပ်ဘာသာနှင့် မြန်မာဘာသာဖြင့် ထုတ်ပြန်ပါသည်။ ဘာသာဗားရှင်းနှစ်ခုလုံးတွင် တူညီသော ဥပဒေရေးရာ အကျိုးသက်ရောက်မှု ရှိပါသည်။`,
    },
  },
];
